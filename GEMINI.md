# InputBox gh-pages - Antigravity / Gemini 相容入口

本檔是 Antigravity CLI 與 Gemini 相容工具在 `gh-pages` 分支的 context 入口。Antigravity CLI 官方遷移文件指出 workspace context 會讀取 `GEMINI.md` 與 `AGENTS.md`，因此本檔只做薄相容層，避免和共同規範重複。
