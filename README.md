...
- **控制器 API 支援**：
  ...
  - **GameInput**：若設定選用此控制器 API，系統必須安裝有 **GameInput 可轉散發組件（Redistributable）**。
...
- [GameInput.Net](https://github.com/Cephy314/GameInputNet)：由 [Cephy314](https://github.com/Cephy314) 開發並採用 **MIT License** 授權，用於存取 GameInput 介面。
