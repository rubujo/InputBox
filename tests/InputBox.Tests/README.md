...
| `GameInputPrimitivesTests` | 自有 GameInput shim 受控資料模型，涵蓋官方 v3 gamepad button 位元、timestamp 診斷欄位、edge detection timestamp 忽略、runtime probe／ABI size 診斷、Gamepad-only 邊界與擴充 device info / capabilities 轉換 | 9 |
